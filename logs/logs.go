...
func StartLog() {
	...
	logs.SetLogger(logs.AdapterMultiFile, string(b))
	logs.EnableFuncCallDepth(logConfig.EnableFuncCallDepth)
	logs.SetLogFuncCallDepth(logConfig.LogFuncCallDepth)
	logs.Async()
